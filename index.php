...
<section class = "home_section">
    <div class="section-header">
		...
		<div class="section-tagline">
            From as low as Rs 3000 per day with limited time offer discounts
		</div>					
	</div>
</section>
				...
				<form method="POST" action = "reserve.php" class = "car-reservation-form" id = "reservation_form" v-on:submit = "checkForm">
					...
					<div>
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" name = "pickup_location" placeholder = "New Bel Road" v-model = 'pickup_location'>
						...
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" name = "return_location" placeholder = "New Bel Road" v-model = 'return_location'>
